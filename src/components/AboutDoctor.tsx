        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className={`relative transition-all duration-700 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-x-8'}`}>
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-emerald-800 to-emerald-900 rounded-3xl p-10 flex flex-col items-center justify-center min-h-[400px]">
                <div className="w-28 h-28 rounded-full bg-gold-gradient flex items-center justify-center mb-6 shadow-gold-lg">
                  <span className="text-white font-serif font-bold text-4xl">Y</span>
                </div>
                <h3 className="text-white font-serif text-2xl font-bold text-center">Dr. Yamini Kiran Pasupuleti</h3>
                <p className="text-gold-400 text-sm mt-2 text-center">PG Diploma in Cosmetology & Aesthetics</p>
                <div className="mt-6 px-6 py-2 bg-gold-500/10 border border-gold-500/20 rounded-full">
                  <span className="text-gold-400 text-sm font-medium">10+ Years Experience</span>
                </div>
                <div className="mt-6 grid grid-cols-2 gap-3 w-full max-w-sm">
                  {expertise.map((item) => (
                    <div key={item.text} className="flex items-center gap-2 px-3 py-2 bg-white/5 rounded-lg">
